...
本项目基于 [Claude Code](https://github.com/anthropics/claude-code) 的源码，通过 **12 章由浅入深的教学内容**，帮助开发者理解一个**生产级 AI 编程助手**的内部架构和工程决策。

项目包含三个核心部分：

| 部分 | 说明 |
|------|------|
| 📖 **深度文档** (`docs/`) | 12 篇源码解析文档，每章聚焦一个核心子系统 |
...
每个章节页面包含 4 个 Tab：
- **可视化** — 交互式步进动画（12 个独立可视化组件）
- **模拟器** — Agent 循环消息流回放（12 个场景数据）
