...
export function Header() {
  ...
  const links = [
    { href: "/", label: "首页" },
    { href: "/chapter/ch01", label: "学习", match: "/chapter" },
    ...
    <header className="sticky top-0 z-50 border-b border-zinc-800 bg-zinc-950/80 backdrop-blur-sm">
      <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-4">
        <Link href="/" className="flex items-center gap-2 font-semibold text-white no-underline">
          ...
          <span>Deep Dive Claude Code</span>
        </Link>
        <nav className="flex items-center gap-1">
          ...
          <a
            ...
            className="ml-2 flex items-center gap-1.5 rounded-md px-3 py-1.5 text-sm text-zinc-400 no-underline transition-colors hover:text-white"
          >
